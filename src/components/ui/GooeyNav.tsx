...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  useEffect(() => {
    ...
    const activeLi = navRef.current.querySelectorAll<HTMLLIElement>("li")[activeIndex]
    if (activeLi) {
      updateEffectPosition(activeLi)
      textRef.current?.classList.add("active")
    }
    const resizeObserver = new ResizeObserver(() => {
      const currentActiveLi = navRef.current?.querySelectorAll<HTMLLIElement>("li")[activeIndex]
      if (currentActiveLi) {
